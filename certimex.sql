...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-02-2017 a las 01:03:32
...
--
ALTER TABLE `img_noticias`
  MODIFY `id_img` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
--
...
--
ALTER TABLE `noticias`
  MODIFY `id_noticias` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
--
