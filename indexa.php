...
<header id="header">
	<div class="container">
		<div class="row">
			<div class="col-sm-4 col-md-4 col-xs-2" style="background-color:blue"><img class="" width="50px" src="assets/images/certimex-logo.png" alt="icon"/></div>
			<div class="col-sm-4 col-md-4 col-xs-8"style="background-color:red">
				
				<h1 class="logo">
				<a class="scrollto" href="#header">
					<img class="" width="50px" src="assets/images/certimex-logo.png" alt="icon"/>
					<img class="" width="100px" src="assets/images/certimex-slogan.png" alt="icon"/>
				</a>
				</h1><!--//logo-->
			</div>
			<div class="col-sm-4 col-md-4 col-xs-2" style="background-color:blue"> 	
		...
		<div class="navbar-collapse collapse" id="navbar-collapse">
			<ul class="nav navbar-nav">
				<li class="active nav-item">
					<a class="scrollto" href="#inicio">INICIO</a>
				</li>
				<li class="active nav-item">
					<a class="scrollto" href="#acerca">CERCA DE</a>
				</li>
				<li class="active nav-item">
					<a class="scrollto" href="#servicios">SERVICIOS</a>
				</li>
				<li class="active nav-item">
				   <a class="scrollto" href="#procedimientos">PROCEDIMIENTOS</a>
				</li>
				<li class="active nav-item">
					<a class="scrollto" href="#ultimasn">ULTIMAS NOTICIAS</a>
				</li class="active nav-item">
				<li class="active nav-item">
